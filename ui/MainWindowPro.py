...
class Ui_MainWindow(QMainWindow):
    ...
    def __initUI__(self):
        ...
        self.run_Button.clicked.connect(self.__run__)
        self.actionExport_TIFF.triggered.connect(self.__export_TIFF__)
        self.actionExport_Image.triggered.connect(self.__export_Image__)
    ...
    def __export_TIFF__(self):
        file_name, _ = QFileDialog.getSaveFileName(self, 'save file', './', "TIFF (*.tif)")
        print(file_name)
